...
elseif strcmp(atlas,'Seitzman300')
    ...
    atlas_params.MNI_nii_file = [atlasdir '/Seitzman300/Seitzman300_MNI_res02_allROIs.nii'];
...
elseif strcmp(atlas,'Seitzman300-res1')
    atlas_params.atlas = atlas;
    
    atlas_params.roi_file = [atlasdir '/Seitzman300/ROIs_300inVol_MNI_allInfo.txt']; % text file with ROI info
    atlas_params.anat_labels = [atlasdir '/Seitzman300/ROIs_anatomicalLabels.txt']; % text file with anatomical labels for each ROI
    atlas_params.MNI_nii_file = [atlasdir '/Seitzman300/Seitzman300_MNI_res01_allROIs.nii'];
...
elseif strcmp(atlas,'Parcels333')
    ...
    atlas_params.atlas = atlas;
    assignments = load([atlasdir 'Evan_parcellation/ParcelCommunities.txt']);
    ...
    atlas_params.atlas_file = 'Evan_parcellation/parcel_centers/Parcels_711-2b_withcoords_roilist';
    atlas_params.roi_file = [atlasdir 'Evan_parcellation/parcel_centers/parcel_center_7112b.roi'];
